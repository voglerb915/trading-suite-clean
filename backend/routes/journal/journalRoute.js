...
// Leseroute für das Journal (Executed Orders + OrderCreation Join)
router.get('/executed', async (req, res) => {
    try {
        ...
        const result = await journalPool.request().query(`
            SELECT 
                E.execution_id,   -- 👈 Hier wird die execution_id jetzt mitgeliefert!
                ...
                C.initial_sl AS initial_sl,
                E.executed_qty AS quantity,
        ...
        console.error("!!! SQL FEHLER IM JOURNAL READER (journalRoute) !!!");
